namespace SpectreWeather.Factory
{
    ...
    {
        public static Func<IEnumerable<IForecast>> GetCurrentConditions(Action<object> notifyOnError)
        {
            return new ForecastApi(new[]
            {
                ForecastSource.OpenWeatherMap.ForecastSource.Get(() =>
                ...
                ForecastSource.WunderGround.ForecastSource.Get(() => WunderGroundResponse)
            }, notifyOnError).GetCurrentConditions;
        }

        private static string WunderGroundResponse =
